...
<body>
  ...
  <div class="header">
    <div><i class="fas fa-fish"></i> ตู้ปลาอัตโนมัติ</div>
    <div class="clock-display" id="clock">00:00:00</div>
  </div>
  
  <div class="tab-container">
    <div class="tab">
      <button id="btn-status" class="tablinks active" onclick="openTab(event, 'Status')">หน้าหลัก</button>
    ...
    <div class="container dashboard-row">
      <div class="card">
        ...
        <div class="status-grid">
          <div class="status-item"><span>หลอดไฟ</span><span id="s-light" class="status-val">...</span></div>
      ...
      <div class="card">
        ...
        <div class="control-grid">
          ...
          <button class="btn btn-oxy" onclick="toggle('oxygen', 'on')"><i class="fas fa-wind"></i>เปิดออกซิเจน</button>
          <button class="btn btn-off" onclick="toggle('oxygen', 'off')"><i class="fas fa-power-off"></i>ปิดออกซิเจน</button>
